...
public class VirtueMartHomePage extends BasePage {
	...
	public WebElement clickOnShowCart(WebDriver driver) throws Exception {
	...
	public WebElement checkProductList(WebDriver driver) throws Exception {
	   ...
	   List<WebElement> productList = driver.findElements(By.className("vm-cart-item-name"));
		for(int i = 1; i< productList.size(); i++) {
			...
			if(productList.size() > 2 ) {
				...
				//Thread.sleep(1000);
				element = driver.findElement(By.xpath("//a[text()='Zipper pullover']//parent::td//parent::tr//following-sibling::button[contains(@name,'delete')]"));
				JavascriptExecutor jse1 = (JavascriptExecutor)driver;
				jse1.executeScript("arguments[0].click()", element);
	...
	public WebElement checkTermsAndConditionBox(WebDriver driver) throws Exception {
	...
	//	jse.executeScript("window.scrollBy(0,document.body.scrollHeight)");
		...
		//Thread.sleep(1000);
		//element = driver.findElement(By.xpath("//input[@class='terms-of-service required' and @value='1']\")"));
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		jse.executeScript("arguments[0].click()", element);
		return element;
	...
	public WebElement clickonConfirmPurchase(WebDriver driver) throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, 100);
		element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@name='confirm']//span[text()='Confirm Purchase']")));
		//Thread.sleep(1000);
		//element = driver.findElement(By.xpath("\"//button[@name='confirm']//span[text()='Confirm Purchase']\")"));
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		jse.executeScript("arguments[0].click()", element);
		return element;
